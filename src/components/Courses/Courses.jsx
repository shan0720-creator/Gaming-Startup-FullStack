...
import { Button, Container,Heading,Input, Text,HStack ,Stack, VStack,Image} from '@chakra-ui/react'
...
const Courses = () => {
  ...
  return (<Container minH={"95vg"} maxW="container.lg" paddingY={"8"}>
  ...
  <Stack direction={["column","row"] }
   ...
   alignItems={['center','flex-start']}>
    ...
    description={"Sample"}
    views={23}
    imageSrc={"https://process.fs.teachablecdn.com/ADNupMnWyR7kCWRvm76Laz/resize=width:705/https://cdn.filestackcontent.com/Uh15KQBQlawaq3PLzQyq"}
    id={"Sample"}
    creator={"Sample boy"}
    lectureCount={2}
